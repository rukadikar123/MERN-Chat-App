...
function Signup() {
  ...
  const handleSignup=async(e)=>{
    e.preventDefault()
    try {
      let result= await axios.post(`${import.meta.env.VITE_API_URL}/api/auth/register`,{
        username:userName,
        email,
        password
  ...
  return (
    <div className='w-full h-[100vh] bg-slate-200  flex items-center justify-center'>
        <div className='w-full max-w-[500px] h-[600px] flex flex-col gap-10 bg-white rounded-lg shadow-lg shadow-gray-400'>
          ...
          <form onSubmit={handleSignup} className='w-full flex flex-col gap-4 items-center p-2 '>
